...
Name: Leonid Shuster
Lab: 0
Role: Class to create vehicle graphics
...
class VehicleGeometry():
	...
	def getNewPoints(self, x, y, z, yaw, pitch, roll):
		...
		frameIntertial = MatrixMath.matrixMultiply(self.vertices, Rotations.euler2DCM(yaw, pitch, roll)) # Get DCM from euler angles and convert from body frame to inertial frame

		frameOffset = MatrixMath.matrixOffset(frameIntertial, x, y, z) # Add offsets in inertial frame

		newPoints = Rotations.ned2enu(frameOffset) # Convert to ENU
